...
-- List all Branches and the number of books they have
SELECT BR.Branchname, BK.BookTitle, BL.Quantity
FROM BOOKLOCATION BL
JOIN BRANCHES BR ON BL.BranchID = BR.BranchID
JOIN BOOK BK ON BL.BookID = BK.BookID;
